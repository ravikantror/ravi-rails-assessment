...
class DetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detail" do
    assert_difference("Detail.count") do
      post details_url, params: { detail: { age: @detail.age, email: @detail.email, person_id: @detail.person_id, phone: @detail.phone, title: @detail.title } }
    end
  ...
  test "should update detail" do
    patch detail_url(@detail), params: { detail: { age: @detail.age, email: @detail.email, person_id: @detail.person_id, phone: @detail.phone, title: @detail.title } }
